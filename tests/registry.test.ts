...
describe('service registry', () => {
  ...
  it('requires a server only for a service with no usable default', () => {
    ...
    expect(getKind('talk')!.serverRequired).toBe(true);
    expect(getKind('element')!.serverRequired).toBeUndefined();
    expect(effectiveUrl(getKind('element')!, undefined)).toBe('https://app.element.io/');
  });
